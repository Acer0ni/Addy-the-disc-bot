...
class paperTrading(commands.Cog):
    ...
    async def cmd_show_holding(self, ctx):
        ...
        with Session() as session:
            ...
            response_string = f"{ctx.author}{new_line} Total worth: {user_obj.crypto_wallet.balance + holding_total}{new_line} Balance: ${user_obj.crypto_wallet.balance}{new_line}Holdings: {new_line}Total value: ${holding_total}{new_line}"
